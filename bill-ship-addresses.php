...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Address (Bldg No,/Floor/Unit/Barangay)<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">City<span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Region<span>*</span></label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Postal Code<span>*</span></label>
